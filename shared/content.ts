...
export const myths = [
  ...
  { m: "Cold numbers are 'due'", t: "#45 is our coldest number — 119 hits in 1,159 draws, against 175 for #15. It still has the same ~12.2% chance this draw as #15 does. Draws have no memory.", e: "🧊", verdict: "The lottery doesn't owe you anything" },
...
export const funFacts = [
  // Percentages below are against the 1,159-draw dataset (596 Mon + 563 Thu).
  // They previously used a ~1,190 denominator left over from an earlier
  // refresh, which understated every figure by about 0.4 points.
  { n: "#15", stat: "175 appearances", label: "Most frequent number", detail: "Shows up in 15.1% of all draws — but χ² says it's noise. Flukes happen at scale.", accent: "terracotta" as Accent, emoji: "🔥" },
  { n: "#45", stat: "119 appearances", label: "Least frequent number", detail: "Would need 23 more hits just to reach the 141.9 average. Random variance — not rigged, not cursed.", accent: "sage" as Accent, emoji: "🌿" },
  ...
  { n: "43.0%", stat: "498 draws", label: "Draws with zero carryover", detail: "In nearly half of all draws, not a single number repeated from the previous one.", accent: "terracotta" as Accent, emoji: "♻️" },
